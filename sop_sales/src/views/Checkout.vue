        ...
        <b-media >
            <div>
                <b-row v-if="wallet >= total">
                    <b-col cols="10" ><strong style="font-size:24px; color: lime">ยอด Wallet คงเหลือ</strong></b-col>
                    <b-col><strong style="font-size:24px;color: lime; float: right;">{{ wallet }}</strong></b-col>
                </b-row>
                <b-row v-else>
